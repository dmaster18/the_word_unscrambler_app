...
#Adds all two- through nine-letter words to collections from all letter groupings
  def generate_letter_word_collections
    ...
    self.two_letter_word_collection = self.two_letter_word_collection.uniq.flatten.sort
    self.three_letter_word_collection = self.three_letter_word_collection.uniq.flatten.sort
    self.four_letter_word_collection = self.four_letter_word_collection.uniq.flatten.sort
    self.five_letter_word_collection = self.five_letter_word_collection.uniq.flatten.sort
    self.six_letter_word_collection = self.six_letter_word_collection.uniq.flatten.sort
    self.seven_letter_word_collection = self.seven_letter_word_collection.uniq.flatten.sort
    self.eight_letter_word_collection = self.eight_letter_word_collection.uniq.flatten.sort
    self.nine_letter_word_collection = self.nine_letter_word_collection.uniq.flatten.sort
    self
  end
